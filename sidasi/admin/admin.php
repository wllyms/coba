        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-1">Data Admin</h5>
                        <p>Data diambil langsung dari database <b class="text-warning">SIDASI</b></p>
                    </div>
                    <div class="font-22 ms-auto"><a href="admin-tambah.php" class="btn btn-light"><i class="bx bx-plus"></i> Tambah Data</a></div>
                </div>
                <hr>
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="example2" class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"><span class="badge bg-success">Aktif</span></a>
                                            <a href="#"><span class="badge bg-danger">Blokir</span></a>
                                        </td>
                                        <td>a</td>
                                        <td>a</td>
                                        <td>a</td>
