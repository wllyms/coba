...
<head>
    ...
    <title>Sidasi - Tambah Admin</title>
</head>
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-1">Tambah Admin</h5>
                        <p class="mb-0 font-13">Silahkan menambahkan data Admin pada form dibawah ini, password default adalah <b>admin</b></p>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nm_admin" id="nm_admin" placeholder="Nama Lengkap dengan Gelar" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="kode_prodi" id="kode_prodi" required>
                                            <option value="">-- Pilih Prodi --</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="telp" class="form-label">Telpon :</label>
                                        <input type="number" class="form-control" name="telp" id="telp" placeholder="Telpon aktif Whatsup" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email :</label>
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Email aktif Anda" required>
                                    </div>
                                    <div class="mb-3">
