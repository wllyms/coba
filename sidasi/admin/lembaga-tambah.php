...
if (isset($_POST["submit"])) {
    ...
    $nm_lembaga = htmlspecialchars($_POST["nm_lembaga"]);

    $query = "INSERT INTO tbl_lembaga_akred VALUES(NULL, '$nm_lembaga')";
...
<head>
    ...
    <title>Sidasi - Tambah Lembaga Akreditasi</title>
</head>
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tambah Lembaga Akreditasi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-1">Tambah Lembaga Akreditasi</h5>
                        <p class="mb-0 font-13">Silahkan menambahkan data Lembaga Akreditasi pada form dibawah ini...!</p>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nm_lembaga" id="nm_lembaga" placeholder="Nama Lembaga Akreditasi" required>
                                    </div>
                                    <div class="mb-3">
